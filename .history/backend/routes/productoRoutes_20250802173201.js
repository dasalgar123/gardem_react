...
// Revisar estructura de la tabla productos
router.get('/estructura', productoController.revisarEstructuraProductos);

// Obtener productos de ejemplo
router.get('/ejemplo', productoController.obtenerProductosEjemplo);
